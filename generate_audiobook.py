...
# This module is intended for import and use in Python scripts and notebooks.
# All CLI-specific code has been removed for notebook compatibility.

# To generate an audiobook, import and call:
